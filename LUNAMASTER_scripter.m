...
x = 820; %centre
y = 1009; %These coordinates are at the bottom mid in the beatbar 
% Spécifiez la couleur à détecter

colorToDetect = [202 198 199]; % Remplacez R, G et B par les valeurs de la couleur à détecter
%this is aproximately white

% Spécifiez la tolérance de couleur

colorTolerance = 70; % Ajustez cette valeur selon votre besoin
