...
outputfilename2='666.funscript';%give the name of the funscript file
% Spécifiez le nom des fichiers de sortie
%%%you can ignore the next names 
filenames = '1111111112111111111111111111111.funscript';
newFilename = '2111111112111111111111111111.funscript';
outputfilename='3111111112111111111111111111.funscript';
...
y = 965; %These coordinates are at the bottom mid in the beatbar 

% Spécifiez la couleur à détecter

colorToDetect = [250 214 234]; % Remplacez R, G et B par les valeurs de la couleur à détecter
