...
filename = 'HMV000 - Tutorial.mp4'; % Give the name of the video !
outputfilename2='0000000.funscript';%give the name of the funscript file
% Spécifiez le nom des fichiers de sortie
%%%you can ignore the next names 
filenames = '1111111112111111111111111111.funscript';
newFilename = '21111111121111111111111111.funscript';
outputfilename='3111111112111111111111111.funscript';
...
y = 969; %These coordinates are at the bottom mid in the beatbar 

% Spécifiez la couleur à détecter

colorToDetect = [255 219 221]; % Remplacez R, G et B par les valeurs de la couleur à détecter
